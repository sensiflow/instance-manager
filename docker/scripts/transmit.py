# code adapted for streaming.   src: ./detected.py by YOLOv5 🚀 by Ultralytics, AGPL-3.0 license
"""
Changes:
...
from streamer_rtsp import StreamerRTSP
...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # Setup streamer
            if streamer is None:
                streamer = StreamerRTSP(destination, im0.shape[1], im0.shape[0], FPS)
